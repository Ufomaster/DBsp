...
/*$Modify:     Zapadinskiy Anatoliy$    $Modify date:   19.07.2012$*/
/*$Version:    1.00$   $Decription: Выбор технологии производства заказного листа для Спецификации ReadOnly режим$*/
create PROCEDURE [dbo].[sp_ProductionCardCustomizeProperties_SelectReadOnly_Specification]
