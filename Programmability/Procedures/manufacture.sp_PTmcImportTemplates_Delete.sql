...
/*$Modify:     Poliatykin Oleksii$      $Modify date:   12.03.2018$*/
...
BEGIN
    ...
    INNER JOIN manufacture.PTmcImportTemplates i
        ON i.JobStageID = js.ID AND ISNULL(i.isDeleted,0) = 0
    INNER JOIN manufacture.PTmcImportTemplateColumns c
        ON c.TemplateImportID = i.ID
