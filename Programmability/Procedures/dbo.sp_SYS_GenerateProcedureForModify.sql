...
/*$Version:    1.00$   $Description: Генерация хранимых процедур на Модификацию*/
create PROCEDURE [dbo].[sp_SYS_GenerateProcedureForModify]
...
/*$Version:    1.00$   $Description: Редактирование ' + @TableName + '*/
...
' + REPLICATE(' ', 8) + 'FastExecSQL(str,[' + @ParamList +'], 
' + REPLICATE(' ', 24) + '[' + @ParamNameList  +'], 
' + REPLICATE(' ', 24) + 'ADODataset.Connection);'    
END
GO