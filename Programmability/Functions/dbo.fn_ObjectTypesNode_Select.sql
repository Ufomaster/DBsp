...
CREATE FUNCTION [dbo].[fn_ObjectTypesNode_Select] (@ParentID Int = NULL)
...
/*  old recursion
    ...
    INSERT INTO @Tmp(ID)
    SELECT ID FROM ObjectTypes WHERE ParentID = @ParentID
    ...
    BEGIN
        ...
        INSERT INTO @T(ID)
        SELECT ID
        FROM dbo.fn_ObjectTypesNode_Select(@CurParentID)
