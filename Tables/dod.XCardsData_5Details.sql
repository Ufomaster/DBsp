CREATE TABLE [dod].[XCardsData_5Details] (
  [ID] [int] IDENTITY,
  ...
  CONSTRAINT [PK_XCardsData_5Details_ID] PRIMARY KEY CLUSTERED ([ID])
)
ON [PRIMARY]
GO

CREATE INDEX [IDX_XCardsData_5DetailsSector]
  ON [dod].[XCardsData_5Details] ([Sector])
  ON [PRIMARY]
GO

CREATE INDEX [IDX_XCardsData_5DetailsXCardsDataID]
  ON [dod].[XCardsData_5Details] ([XCardsDataID])
  ON [PRIMARY]
GO

ALTER TABLE [dod].[XCardsData_5Details]
  ADD CONSTRAINT [FK_XCardsData_5Details_XCardsData_ID] FOREIGN KEY ([XCardsDataID]) REFERENCES [dod].[XCardsData_5] ([ID])
GO