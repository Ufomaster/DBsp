CREATE TABLE [StorageData].[pTMC_45534H] (
  [ID] [int] IDENTITY,
  ...
  CONSTRAINT [PK_pTMC_45534H_ID] PRIMARY KEY CLUSTERED ([ID])
)
ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_CurrentDate', @objname = N'StorageData.pTMC_45534H.ModifyDate'
GO