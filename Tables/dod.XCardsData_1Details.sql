CREATE TABLE [dod].[XCardsData_1Details] (
  [ID] [int] IDENTITY,
  ...
  CONSTRAINT [PK_XCardsData_1Details_ID] PRIMARY KEY CLUSTERED ([ID])
)
ON [PRIMARY]
GO

CREATE INDEX [IDX_XCardsData_1DetailsSector]
  ON [dod].[XCardsData_1Details] ([Sector])
  ON [PRIMARY]
GO

ALTER TABLE [dod].[XCardsData_1Details]
  ADD CONSTRAINT [FK_XCardsData_1Details_XCardsData_ID] FOREIGN KEY ([XCardsDataID]) REFERENCES [dod].[XCardsData_1] ([ID])
GO