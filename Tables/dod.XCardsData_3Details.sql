CREATE TABLE [dod].[XCardsData_3Details] (
  [ID] [int] IDENTITY,
  ...
  CONSTRAINT [PK_XCardsData_3Details_ID] PRIMARY KEY CLUSTERED ([ID])
)
ON [PRIMARY]
GO

CREATE INDEX [IDX_XCardsData_3DetailsSector]
  ON [dod].[XCardsData_3Details] ([Sector])
  ON [PRIMARY]
GO

ALTER TABLE [dod].[XCardsData_3Details]
  ADD CONSTRAINT [FK_XCardsData_3Details_XCardsData_ID] FOREIGN KEY ([XCardsDataID]) REFERENCES [dod].[XCardsData_3] ([ID])
GO